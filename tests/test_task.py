...
@pytest.fixture()
def create_test_task(client: TestClient, create_user: dict[str, str]) -> str:
...
def test_get_all_tasks(client: TestClient, create_user: dict[str, str]):
...
def test_create_task(client: TestClient, create_user: dict[str, str]):
...
def test_get_task_by_id(client: TestClient, create_user: dict[str, str], create_test_task: str):
...
def test_update_task(client: TestClient, create_user: dict[str, str], create_test_task: str):
...
def test_delete_task(client: TestClient, create_user: dict[str, str], create_test_task: str):
